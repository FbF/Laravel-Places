...
return array(
	...
	/**
	 * Number of fake places to create
	 */
	'number' => 20,
	...
	'you_tube' => array(
		...
		/**
		 * One in every X places is a YouTube Video (use 0 for no YouTube Videos, or set you_tube.show to false)
		 */
		'freq' => 5,
	...
	'images' => array(
		...
		'main_image' => array(
			...
			/**
			 * One in every X places that is not a YouTube Video, has a main image (use 0 for no main images, or set
	...
	'link' => array(
		...
		/**
		 * One in every X places has a link (use 0 for no links)
		 */
		'freq' => 2,
